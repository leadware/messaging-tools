 ...
 * 
 */
package net.leadware.messaging.jms.tools.test.message.impl;
...
/**
 * Classe representant un message IP de type Creation de JOB
 * @author <a href="mailto:jetune@yahoo.fr">Jean-Jacques ETUNE NGI</a>
 * @since 1 févr. 2013 : 14:41:06
 */
public class DefaultTestMessage extends ApplicationMessage<String> {
	 ...
	 */
	public DefaultTestMessage(String payload) {
